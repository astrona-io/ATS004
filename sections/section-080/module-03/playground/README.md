# XFS Quotas and Project Quotas — Playground

- **ID:** PLAYGROUND
- **Slug:** section-080-module-03-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-080-module-03-playground`), not
