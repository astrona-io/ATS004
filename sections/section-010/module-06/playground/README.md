# systemd Mount and Automount Units — Playground

- **ID:** PLAYGROUND
- **Slug:** section-010-module-06-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-010-module-06-playground`), not
