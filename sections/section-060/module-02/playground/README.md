# The Hardware Tree {{title}} Runtime Tuning: /sys {{title}} sysctl — Playground

- **ID:** PLAYGROUND
- **Slug:** section-060-module-02-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-060-module-02-playground`), not
