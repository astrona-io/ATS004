# Navigating Shortcuts: Symbolic Links {{title}} FHS — Playground

- **ID:** PLAYGROUND
- **Slug:** section-080-module-04-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-080-module-04-playground`), not
