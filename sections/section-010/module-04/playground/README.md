# Chapter 4: The Digital Auditor: Filesystem Maintenance, Labeling, {{title}} Tuning — Playground

- **ID:** PLAYGROUND
- **Slug:** section-010-module-04-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-010-module-04-playground`), not
