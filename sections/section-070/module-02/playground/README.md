# Process-Level Auditing: Identifying the Culprit — Playground

- **ID:** PLAYGROUND
- **Slug:** section-070-module-02-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-070-module-02-playground`), not
