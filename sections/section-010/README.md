...
*   **Lab Run Command:**
    ```bash
    astrona run --git git@github.com:astrona-io/ATS004.git -c labs/section-010/module-01/lab-01
    ```
...
*   **Lab Run Command:**
    ```bash
    astrona run --git git@github.com:astrona-io/ATS004.git -c labs/section-010/module-02/lab-01
    ```
...
*   **Lab Run Command:**
    ```bash
    astrona run --git git@github.com:astrona-io/ATS004.git -c labs/section-010/module-03/lab-01
    ```
...
*   **Lab Run Command:**
    ```bash
    astrona run --git git@github.com:astrona-io/ATS004.git -c labs/section-010/module-04/lab-01
    ```
...
*   **Comprehensive Challenge:** **`labs/section-010/capstone/lab-01` (Local Storage Integration)**
*   **Lab Run Command:**
    ```bash
    astrona run --git git@github.com:astrona-io/ATS004.git -c labs/section-010/capstone/lab-01
    ```
