# Software RAID Fundamentals — Playground

- **ID:** PLAYGROUND
- **Slug:** section-030-module-03-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-030-module-03-playground`), not
