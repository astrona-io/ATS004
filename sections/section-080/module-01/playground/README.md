# Directory Capacity Auditing — Playground

- **ID:** PLAYGROUND
- **Slug:** section-080-module-01-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-080-module-01-playground`), not
