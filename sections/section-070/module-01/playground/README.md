# Device-Level Diagnostics: Queues {{title}} Latency — Playground

- **ID:** PLAYGROUND
- **Slug:** section-070-module-01-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-070-module-01-playground`), not
