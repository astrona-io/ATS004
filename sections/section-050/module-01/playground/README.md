# On-Demand Mounting Fundamentals — Playground

- **ID:** PLAYGROUND
- **Slug:** section-050-module-01-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `section-050-module-01-playground`), not
